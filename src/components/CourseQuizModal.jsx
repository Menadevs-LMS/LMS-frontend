...
const CourseQuizModal = ({
    ...
    const isAddButtonDisabled = !currentQuestion.questionText || 
        (currentQuestion.questionType === 'multiple-choice' && 
         (!currentQuestion.options.some(opt => opt.trim() !== '') || !currentQuestion.correctAnswer));
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-75 backdrop-blur-sm overflow-auto z-50 p-4">
            <div className="bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 p-6 rounded-lg shadow-xl relative w-full max-w-2xl max-h-[85vh] overflow-auto transition-all transform animate-fadeIn">
                ...
                <div className="space-y-5">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700/50 p-5 rounded-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <button
                            ...
                            disabled={isAddingQuestion || isAddButtonDisabled}
                                            ...
                                            <div>
                                                ...
                                                <span className="ml-2 text-xs text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-600 px-2 py-0.5 rounded">
                                                    {q.questionType === 'multiple-choice' ? 'Multiple Choice' : 
                                                     q.questionType === 'truth-sentence' ? 'True/False' : 'Paragraph'}
                                                </span>
                                            </div>
                                        </div>
                                        <button
                ...
                <div className="mt-8 flex gap-3">
                    ...
                    <button
                        ...
                        className={`flex-1 px-4 py-2.5 font-medium rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-400 ${
                            quizData.questions.length === 0 || !quizData.title
                                ? 'bg-gray-200 text-gray-500 cursor-not-allowed dark:bg-gray-700 dark:text-gray-400'
